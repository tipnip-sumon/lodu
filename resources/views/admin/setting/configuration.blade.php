                ...
                <form method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Referral Program')</p>
                                    <p class="mb-0">
                                        <small>@lang('Here, you can enable or disable the Referral program. After disabling this, the Referral program will no longer work on this system.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="referral_program" @if (gs('referral_program')) checked @endif>
                                </div>
                            </li>
                        </ul>
                    </div>
